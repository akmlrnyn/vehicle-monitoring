                    ...
                    <div class="flex w-full flex-col gap-3">
                        <div class="card w-auto md:w-auto h-fit bg-white p-4 rounded-lg shadow-md">
                            <h2 class="text-base md:text-xl font-semibold">
                                Cars available in {{$currentOffice}}
                            </h2>
                            @if ($vehicles->count() == 0)
                        ...
                        <!-- stats section -->
                        <div class="grid lg:grid-cols-2 md:grid-cols-1 gap-6 w-full max-w-6xl">
                            <!-- Tile 1 -->
                            <div class="flex items-center p-4 bg-white rounded shadow-md">
                                <div
                                    ...
                                    <svg class="w-4 sm:w-6 h-6 fill-current text-blue-700"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd"
                                            d="M3.293 9.707a1 1 0 010-1.414l6-6a1 1 0 011.414 0l6 6a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L4.707 9.707a1 1 0 01-1.414 0z"
                                            clip-rule="evenodd" />
                                    </svg>
                                    <svg class="w-4 sm:w-6 h-6 fill-current text-red-700"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd"
                                ...
                                <div class="flex-grow flex flex-col ml-4">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <span class="text-xs sm:text-base text-gray-500 text-sm">Staff
                                            Performance</span>
                                        <a href="" class="text-purple-500 text-xs sm:text-sm font-semibold ml-2">See
                                            more...</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center p-4 bg-white rounded shadow-md">
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3 sm:w-6" viewBox="0 0 320 512">
                                ...
                                <div class="flex-grow flex flex-col ml-4">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <span class="text-xs sm:text-base text-gray-500 text-sm">The Staff Salary</span>
                                        <span class="text-yellow-700 text-xs sm:text-sm font-semibold ml-2"><a
                            ...
                            <div class="flex items-center p-4 bg-white rounded shadow-md">
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3 sm:w-6" viewBox="0 0 512 512">
                                        <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                        <path fill="#63E6BE"
                                ...
                                <div class="flex-grow flex flex-col ml-4">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <span class="text-xs sm:text-base text-gray-500 text-sm">With One Click</span>
                                        <span class="text-emerald-600 text-xs sm:text-sm font-semibold ml-2"><a
                                                href="">Refresh</a></span>
                                    </div>
                                </div>
                            </div>
