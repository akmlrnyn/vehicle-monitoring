    ...
    <div class="min-h-screen bg-gray-100 p-3 sm:p-12">
        <div class="mx-auto max-w-lg px-6 py-12 bg-white border-0 shadow-lg rounded sm:rounded-2xl">
            <div class="mx-auto mb-4">
                <h2 class="text-gray-700 text-xl sm:text-3xl font-bold">Create new vehicle</h2>
                <p class="text-sm sm:text-base text-gray-500">input new vehicle data</p>
            </div>
            <form id="form" method="POST" action="{{ route('vehicle.store') }}">
                @csrf
                ...
                <div class="relative z-0 w-full mb-2">
                    <label class="text-gray-500 text-xs sm:text-sm" for="gas_consumption">Gas Consumption</label>
                ...
                <div class="relative z-0 w-full mb-5">
                    ...
                    <select id="owner" type="text" required name="owner" value=""
                ...
                <div class="relative z-0 w-full mb-5">
                    ...
                    <select id="office_owner" required type="text" name="office_id"
                        class="pb-2 block text-sm sm:text-base w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-blue border-gray-200">
